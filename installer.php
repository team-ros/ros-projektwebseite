...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'Test_projekt_ros_13864b9e71d848f98002_20201023101014_archive.zip';
	const ARCHIVE_SIZE		 = '46348302';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '13864b9-23101014';
    const SECONDARY_PACKAGE_HASH = '87ac6bd-23101014';
